...
class Module:
    ...
    async def run(self):
        ...
        try:
            ...
            subroutines.append(asyncio.Task(self.internal_message_handler()))
    ...
    async def internal_message_router(self, msg):
        """
...
class SubModule(Module):
    ...
    async def run(self):
        ...
        """
        try:
            internal_message_router_task = asyncio.Task(self.internal_message_handler())
