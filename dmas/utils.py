...
class EngineeringModuleParts(Enum):
    ...
    IRIDIUM_PLATFORM_SIMULATION = 'IRIDIUM_PLATFORM_SIMULATION'
...
class AgentModuleTypes(Enum):
    ...
    IRIDIUM_ENGINEERING_MODULE = 'IRIDIUM_ENGINEERING_MODULE'
    GROUND_ENGINEERING_MODULE = 'GROUND_ENGINEERING_MODULE'
...
class PlanningSubmoduleTypes(Enum):
    ...
    CENTRAL_PLANNING = 'CENTRAL_PLANNING'
