...
if __name__ == '__main__':
    ...
    environment = EnvironmentServer(scenario_dir, ['Landsat 9', 'Jason-3', 'CryoSat-2', 'Sentinel-6A', 'Sentinel-6B', 'SWOT', 'Iridium', 'Central Node'], duration, clock_type=SimClocks.REAL_TIME_FAST, simulation_frequency = 100.0)
