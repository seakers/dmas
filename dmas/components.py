...
# class Component:
#     def __init__(self, name, power, energy_stored, energy_capacity,
#                  data_rate, data_stored, data_capacity, status=False):
#         """
#         Abstract component class. Tracks the state of a generic component that can generate, consume, or store data and 
#         power when it is activated.
...
#         self.power = power
#         self.energy_storage = Container(energy_stored, energy_capacity)
        
#         self.data_rate = data_rate
#         self.data_storage = Container(data_stored, data_capacity)

#     def activate(self):
#         """
#         Initializes 
#         """
#         self.energy_storage.activate()
#         self.data_storage.activate()

#     def is_on(self):
#         """
#         Returns True if the component is on
#         :return:
#         """
#         return self.status
